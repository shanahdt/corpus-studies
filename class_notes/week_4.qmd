...
<h2> The Nokia Theme (originally from Tarrega's "Grand Valse"-1902)</h2>
<div style="padding-bottom:30px" id="notation-nokia"></div>


<script id="humdrum-nokia" type="text/x-humdrum">
**kern
*clefG2
*M3/4
=1
...
document.addEventListener("DOMContentLoaded", (event) => {
   Module.onRuntimeInitialized = async _ => {
      ...
      let humdrumTwinkle = document.querySelector("#humdrum-nokia").textContent.replace(/^\s+/, "");
      let verovioOptions = {
         scale:           40,
         pageWidth:     1500,
         pageHeight:   60000,
      ...
      let elementTwinkle = document.querySelector("#notation-nokia");
