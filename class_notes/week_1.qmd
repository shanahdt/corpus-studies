...
The definitions we used in week 1 were largely drawn from Popper, and will be looking at other alternatives as we move forward. For Popper science is the progress of knowledge, and 
theories are meant to be tested, refuted, and built upon. This led us some of [slogans](../emp_methods_workshop/slogans.qmd) from David Huron's workshops, such as "Our aim is not to be right, but to be not *not* right."
...
See [this page from Huron's workshop](../emp_methods_workshop/big_ideas.qmd) for a nice description of these concepts.

### Types of Studies

See [this page on types of studies](../emp_methods_workshop/empirical2.qmd)
