...
1.  **Welcome & Introduction**
    -   [(Introductory comments)](lecture01.html)
    -   Generals Aims & Preview
    -   [Workshop flier](Images/MaxPlanckWorkshop.pdf)
    -   [Learning objectives](goals.html)
    -   [(Comments following learning objectives)](remarks1.html)
...
3.  **Types of Empirical Studies**
    ...
    -   [Reactivity](reactivity.html) [(powerpoint presentation
        #7)](07_reactivity.pdf)
    ...
    -   [Syncopation: From question to hypothesis](syncopation.html)
        [(powerpoint presentation #8)](08_syncopation.pdf)
    -   [Opinions as
...
6.  **Welcome**; encourage mix-up seating/groups
    ...
    -   [The Correlational Study](correlational_study2.html)
        [(powerpoint presentation #10)](10_correlation.pdf)
...
7.  **Sampling**
    ...
    -   **Homework review:** [Review questions and answers for
        Lancashire & Hirst (2009)](reading01.html)
    ...
    -   [Sample Size: Law of Big Numbers](big_numbers.html)
        [(powerpoint presentation #12)](12_sample_size.pdf)
...
8.  **Behavioral Data**
    ...
    -   [Demand characteristics](demand_characteristics.html)
        (includes [Clever Hans](cleverHans.html)) [(powerpoint
        presentation #16)](16_demand_chars.pdf)
        20. *Always debrief.*
    ...
    -   [Designing questionnaires](questionnaires.html) [(powerpoint
        presentation #18)](18_questionnaires.pdf)
...
9.  **Homework**
    -   [Reading Guide #2: Perttu (2007)](reading02.html)
    -   [Reading #2: Perttu (2007)](perttu.pdf)
...
10. **Introduction to Statistics**
    ...
    -   [Descriptive Statistics](stats_descr.html) [(powerpoint
        presentation #19)](19_desc_stats.pdf)
    ...
    -   Inferential statistics [(powerpoint presentation
        #20)](20_inferential_stats.pdf) (including
    ...
    -   [Confidence level and Confidence
        Interval](confidence_level.html) [(powerpoint presentation
        #21)](21_confidence_level.pdf)
    ...
    -   [Chi-square test](chi_test.html) [(powerpoint presentation
        #22)](22_chi_square.pdf)
    ...
    -   Publishing practice [(powerpoint presentation
        #X)](23_reporting.pdf)
...
12. **Some Advanced Analytic Techniques**
    ...
    -   Advanced Analytic Techniques [(powerpoint presentation
        #25)](25_advanced_stats.pdf)
    ...
    -   [Modeling - B-flat trumpet](modeling.html)
        23. *If you torture the data long enough, it will confess to
            anything.*
    -   Foote novelty [(powerpoint presentation
        #25)](26_Foote_Novelty.pdf)
...
16. **Some Useful Tools**
    -   Recall outliers - participants can fall asleep; sometimes you
        get participants who are just ornery
...
18. **The Experience of Research Participants**
    ...
    -   Read in class: Tsay (2013): [An unusual ceiling case: Judging
        performances: sound versus sight](ceiling.html)
        Followed by [discussion](ceiling_discussion.html)
    -   Primacy and recency (people prefer the first thing they hear;
        they best recall the last thing they hear); testing
        individually (cough)
        25. *Randomize stimuli for each participant.*
    -   [Debriefing participants](debriefing.html) (most stressful
        part of experiment was signing consent form)
...
26. **Final advice**
    ...
    -   [Final review of slogans](slogans.html) [(powerpoint
        presentation)](slogans.pdf)
    -   Music's most important discoveries lie ahead
    -   [Feedback for Day 5](feedback5.html)
    -   [Final Feedback](feedback5b.html)
